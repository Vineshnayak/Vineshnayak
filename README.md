...
<li>Currently strengthening expertise in <strong>Python</strong>, <strong>AI/ML</strong>, <strong>advanced SQL</strong>, and <strong>CI/CD pipelines</strong> using <strong>Jenkins</strong> and <strong>GitHub Actions</strong></li>
<li>Actively contributing to open-source projects and building real-time intelligent systems</li>
<li>Certified in Salesforce Agentforce, Google Cloud Gen-AI, and Cisco programs</li>
</ul>
...
![YOLOv8](https://img.shields.io/badge/YOLOv8-111111?style=flat&logoColor=white)
...
- **Salesforce Agentforce Specialist** — AI agent design and deployment
- **Deep Learning & AI (CodeChef)** — Neural networks and deep learning fundamentals
- **Google Cloud Gen-AI Internship** — Generative AI and cloud ML workflows
- **Cisco Certifications** — Python Essentials 2 · Networking Basics · Introduction to Data Science
- **NIELIT CABA** — Computer Applications and Business Accounting
